execute as @p run execute if data entity @s SelectedItem{id:"minecraft:golden_carrot"} run execute at @s run summon item ~ ~ ~ {PickupDelay:0.01,Item:{id:"minecraft:golden_carrot",Count:1,tag:{CustomModelData: 4}}}
